...
![AE-YOLO](assets/aeyolo_pipeline.png)
...
This project uses Python with common deep-learning libraries such as TensorFlow, NumPy, Pandas, and Matplotlib.
...
You can also run the notebook directly on Google Colab after uploading the dataset and notebook files.
...
├── README.md
└── results/                     # optional exported tables and figures
```
...
- **Classes:** 43
- **Task:** traffic sign recognition / detection
- **Source:** Kaggle and benchmark website
...
- **traffic_sign_detection.ipynb**  
  Contains data preprocessing, model building, parameter experiments, result plotting, and evaluation.

### Suggested output folders

- **results/**  
  Stores experiment tables, exported CSV files, and generated figures.

- **assets/**  
  Stores images used in the README, such as the methodology figure or qualitative detection examples.
